...
out=/home/nisa/Tensor_operations/SpMTTKRP_private/perfAllCSFslcAtomic.txt


# for dataset in $path/dense_syn_tns/*.tns; do
for dataset in nell-2_sorted012.tns flickr-3d_sorted012.tns freebase_music_sorted012.tns freebase_sampled_sorted012.tns 1998DARPA_sorted012.tns; do
